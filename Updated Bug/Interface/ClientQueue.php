...
<html>
      ...
      DisplayQueueNumber();
          setInterval(function() {
            ...
            if(assignStaffID == "NULL" && lock == 'FALSE') {
              ...
              lock = 'TRUE';
              document.getElementById("MainMSG").innerHTML =  "You have been assigned to " + Sta_LN + " " + Sta_FN ;
            }
            RetrieveStaffInfo();
          }, 1000);
      });
  ...
  <body>
    ...
    <div class  = "welcome">
      ...
      <p id = "MainMSG" style="margin-left:2.5em">Your Queue Number is 

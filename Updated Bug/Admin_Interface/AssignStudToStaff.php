<?php
    ...
    $Query          =   "SELECT queue_staff.Staff_ID,queue.Student_ID, queue.Queue_Num FROM queue INNER JOIN queue_staff on queue.Queue_Num=queue_staff.Queue_Num=1 ORDER BY Queue_Num ASC LIMIT 1";
